...
async function SmtpSettingsLoader() {
    if (process.env.IS_DOCKER_BUILD === 'true') {
        console.log("[SmtpSettingsLoader - notification-settings] Docker build detected, skipping SMTP settings fetch.");
        return (
...
// Bildirim Ayarları sayfası aslında SMTP ayarlarını içeriyor şimdilik
